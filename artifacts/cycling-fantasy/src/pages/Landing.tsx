...
import { Bike, Trophy, TrendingUp, Zap } from "lucide-react";
    ...
    <div className="min-h-[100dvh] bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-20 text-center relative overflow-hidden">
        ...
        <div className="z-10 max-w-4xl mx-auto space-y-8">
          ...
          <div className="pt-8">
            <Button size="lg" className="h-14 px-8 text-lg font-bold" onClick={login}>
              Start Your Team
            </Button>
          </div>
        </div>
      ...
      <footer className="py-8 text-center text-sm text-muted-foreground border-t z-10 relative bg-background">
        Cycling Fantasy Manager &copy; 2025
      </footer>
    </div>
  );
}